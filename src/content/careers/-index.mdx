...
benifits:
  ...
  benifit_list:
    - title: 01. Fintech
      subtitle: "In the fintech sector, AI is revolutionizing financial services by enhancing security, improving customer experiences, and optimizing operations. Key applications include:"
      content: "
    ...
    - title: 02. E-commerce
      subtitle: "AI is transforming the e-commerce landscape by personalizing shopping experiences and optimizing operations. Key applications include:"
      content: "
    ...
    - title: 03. Healthcare
      subtitle: "In healthcare, AI is improving patient care, streamlining operations, and accelerating medical research. Key applications include:"
      content: "
    ...
    - title: 04. Manufacturing
      subtitle: "AI is driving the fourth industrial revolution in manufacturing, enhancing efficiency and product quality. Key applications include:"
      content: "
    ...
    - title: 05. Marketing
      subtitle: "AI is revolutionizing marketing by enabling hyper-personalization and data-driven decision making. Key applications include:"
      content: "
    ...
    - title: 06. Energy and Utilities
      subtitle: "In the energy sector, AI is driving efficiency, sustainability, and grid management. Key applications include:"
      content: "
    ...
    - title: 07. Automotive
      subtitle: "AI is driving innovation in the automotive industry, from manufacturing to autonomous vehicles. Key applications include:"
      content: "
      ...
      icon: barChart  #icon package react-feather-icon [https://feathericons.com]
    - title: 08. Edtech
      subtitle: "AI is transforming education by personalizing learning experiences and improving educational outcomes. Key applications include:"
      content: "
      ...
      icon: barChart  #icon package react-feather-icon [https://feathericons.com]
    - title: 09. Legal
      subtitle: "In the legal sector, AI is streamlining processes and enhancing decision-making. Key applications include:"
      content: "
      ...
      icon: barChart  #icon package react-feather-icon [https://feathericons.com]
    - title: 10. Logistics
      subtitle: "AI is optimizing supply chains and transforming logistics operations. Key applications include:"
      content: "
    ...
    - title: 11. Media and Entertainment
      subtitle: "AI is revolutionizing content creation, distribution, and audience engagement in media and entertainment. Key applications include:"
      content: "
